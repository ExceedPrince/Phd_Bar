import {
	...
	ADMIN_FILTER_RESERVATION, ADMIN_UNIQUE_MENU, CLEAR_MENUITEM_DATA, NEW_MENUITEM_SUCCESS, NEW_MENUITEM_ERROR,
	MENU_CHANGE_SUCCESS, MENU_CHANGE_ERROR
} from "../types";
...
export default function (state = initialState, action) {
	switch (action.type) {
		...
		case MENU_CHANGE_ERROR:
		case NEW_MENUITEM_SUCCESS:
		case NEW_MENUITEM_ERROR:
